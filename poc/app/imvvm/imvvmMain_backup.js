  ...
  var Main = function(applicationNamespace, appDataContext, dataContexts, dependencies, stateChangedHandler/*, restArgs*/) {
    ...
    var appStateChangedHandler = function(callerDataContext, appState, newState, callback) {
      var appContext,
        ...
        console.log(callerDataContext);
        console.log(appState);
        console.log(newState);

      var AppViewModel = !!appState ? Object.getPrototypeOf(appState).constructor.classType === "AppViewModel" : false;
      
      //Check to see if appState is a ready made state object. If so
      //pass it straight to the stateChangedHandler. If a callback was passed in
      //it would be assigned to newState
      if(AppViewModel && (newState === void 0 || typeof newState === 'function')) {
        ...
        //appState.state = appState.previousState;
        ...
        if(callerDataContext !== appDataContextName){
          ...
          if(Object.keys(appState).length === 0){ //initialise State
      ...
      appContext = new ApplicationDataContext(nextState, previousState).state;
